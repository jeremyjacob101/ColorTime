export const ColorsToRGB: Record<string, readonly [number, number, number]> = {
  "Classic Black": [0, 0, 0],
  "Navy Blue": [0, 0, 128],
  "Dark Blue": [0, 0, 200],
  "Classic Blue": [0, 0, 255],
  "Stratos": [0, 7, 65],
  "Swamp": [0, 27, 28],
